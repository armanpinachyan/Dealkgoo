...
import './popular-cases-item-hover.scss';
...
function PopularCasesItemHover({ elem }: IThisProps) {
  return (
    <div className="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
      <div className="popular-cases-row-box popular-cases-hover">
        <div className="image">
        ...
        <div className="ratting-bloc">
          ...
          <div className="hover-bloc">
            <p className="hover-name">{elem.hover_text}</p>
            <div className="d-flex hover-sub-title">
              {elem.key1} <span>{elem.key1_text}</span>
            </div>
            <div className="d-flex hover-sub-title">
              {elem.key2} <span>{elem.key2_text}</span>
            </div>
            <div className="d-flex hover-sub-title">
              {elem.key3} <span>{elem.key3_text}</span>
            </div>
            <div className="d-flex hover-sub-title">
              {elem.key4} <span>{elem.key4_text}</span>
            </div>
          </div>
...
export default PopularCasesItemHover;
